      ...
      children: List<Widget>.generate(segments.length * 2 - 1, (index) {
        if (index.isOdd) {
          return Padding(
            ...
            child: Text('→', style: context.appTextStyles.breadcrumb),
          );
        }
        ...
        final style = context.appTextStyles.breadcrumb.copyWith(
          color: isCurrent ? context.colors.onSurface : context.colors.onSurfaceVariant,
          fontWeight: isCurrent ? TypographyTokens.medium : TypographyTokens.regular,
        );
